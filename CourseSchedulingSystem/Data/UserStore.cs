...
namespace CourseSchedulingSystem.Data
{
        ...
        IUserLoginStore<User>
    {
        ...
        public Task<User> FindByIdAsync(string userId, CancellationToken cancellationToken = default(CancellationToken))
        {
            cancellationToken.ThrowIfCancellationRequested();
            ThrowIfDisposed();
            return Users.SingleOrDefaultAsync(u => u.Id == new Guid(userId), cancellationToken);
        }
        ...
        public virtual Task<string> GetUserIdAsync(User user,
            CancellationToken cancellationToken = default(CancellationToken))
        {
            cancellationToken.ThrowIfCancellationRequested();
            ThrowIfDisposed();
        ...
        public virtual Task<string> GetUserNameAsync(User user,
            CancellationToken cancellationToken = default(CancellationToken))
        {
            cancellationToken.ThrowIfCancellationRequested();
            ThrowIfDisposed();
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> used to propagate notifications that the operation should be canceled.</param>
        /// <returns>The <see cref="Task"/> that represents the asynchronous operation.</returns>
        public virtual Task SetUserNameAsync(User user, string userName,
            CancellationToken cancellationToken = default(CancellationToken))
        {
            cancellationToken.ThrowIfCancellationRequested();
            ThrowIfDisposed();
        ...
        public virtual Task<string> GetNormalizedUserNameAsync(User user,
            CancellationToken cancellationToken = default(CancellationToken))
        {
            cancellationToken.ThrowIfCancellationRequested();
            ThrowIfDisposed();
        ...
        protected Task<UserRole> FindUserRoleAsync(Guid userId, Guid roleId, CancellationToken cancellationToken)
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> used to propagate notifications that the operation should be canceled.</param>
        /// <returns>The <see cref="Task"/> that represents the asynchronous operation.</returns>
        public async Task AddToRoleAsync(User user, string normalizedRoleName,
            CancellationToken cancellationToken = default(CancellationToken))
        {
            cancellationToken.ThrowIfCancellationRequested();
            ThrowIfDisposed();
            ...
            CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            return await Context.UserClaims.Where(uc => uc.UserId.Equals(user.Id)).Select(c => c.ToClaim())
            ...
            CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            Context.ExternalUserLogins.Add(new ExternalUserLogin
            {
                UserId = user.Id,
            ...
            CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var entry = await Context.ExternalUserLogins
                .SingleOrDefaultAsync(
                    userLogin => userLogin.UserId == user.Id &&
            ...
            if (entry != null)
            {
                Context.ExternalUserLogins.Remove(entry);
            }
        }
            ...
            CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var userId = user.Id;
            return await Context.ExternalUserLogins.Where(l => l.UserId == userId)
            ...
            CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var userLogin = await Context.ExternalUserLogins
                .SingleOrDefaultAsync(l => l.LoginProvider == loginProvider && l.ProviderKey == providerKey,
                    cancellationToken);

            if (userLogin != null)
            {
                return await Users.SingleOrDefaultAsync(u => u.Id == userLogin.UserId, cancellationToken);
            }
